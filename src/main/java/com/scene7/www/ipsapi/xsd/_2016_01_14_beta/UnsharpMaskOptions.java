...
public class UnsharpMaskOptions
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    /**
     * field for Monochrome
     */

    protected int localMonochrome;
    /*  This tracker boolean wil be used to detect whether the user called the set method
   *   for this attribute. It will be used to determine whether to include this field
    *   in the serialized XML
    */
    protected boolean localMonochromeTracker = false;
     ...
     */
    public void setThreshold(int param) {

        // setting primitive attribute tracker to true
        localThresholdTracker =
    ...
    public boolean isMonochromeSpecified() {
        return localMonochromeTracker;
    }
    ...
    public int getMonochrome() {
        return localMonochrome;
    }

    /**
     * Auto generated setter method
     * @param param Monochrome
     */
    public void setMonochrome(int param) {

        // setting primitive attribute tracker to true
        localMonochromeTracker =
                param != java.lang.Integer.MIN_VALUE;

        this.localMonochrome = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":UnsharpMaskOptions",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "UnsharpMaskOptions",
        ...
        if (localThresholdTracker) {
            ...
            if (localThreshold == java.lang.Integer.MIN_VALUE) {
        ...
        if (localMonochromeTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            writeStartElement(null, namespace, "monochrome", xmlWriter);

            if (localMonochrome == java.lang.Integer.MIN_VALUE) {

                throw new org.apache.axis2.databinding.ADBException("monochrome cannot be null!!");

            } else {
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMonochrome));
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localMonochromeTracker) {
            ...
            elementList.add(
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMonochrome));
        }
    ...
    public static class Factory {
         ...
         */
        public static UnsharpMaskOptions parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UnsharpMaskOptions object =
                    new UnsharpMaskOptions();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"UnsharpMaskOptions".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (UnsharpMaskOptions) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "amount")
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "radius")
                        .equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "radius" + "  cannot be null");
                    }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "threshold").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "threshold" + "  cannot be null");
                    }
                    ...
                    object.setThreshold(java.lang.Integer.MIN_VALUE);
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "monochrome").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "monochrome" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setMonochrome(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
                    ...
                    object.setMonochrome(java.lang.Integer.MIN_VALUE);
