/**
 * GetViewerConfigSettingsParam.java
 * <p>
...
/**
 * GetViewerConfigSettingsParam bean class
 */

public class GetViewerConfigSettingsParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getViewerConfigSettingsParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getViewerConfigSettingsParam",
    ...
    public static class Factory {
         ...
         */
        public static GetViewerConfigSettingsParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetViewerConfigSettingsParam object =
                    new GetViewerConfigSettingsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getViewerConfigSettingsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetViewerConfigSettingsParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
