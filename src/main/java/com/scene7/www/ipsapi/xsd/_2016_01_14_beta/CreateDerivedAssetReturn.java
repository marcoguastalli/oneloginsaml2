...
/**
 * CreateDerivedAssetReturn bean class
 */

public class CreateDerivedAssetReturn
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":createDerivedAssetReturn",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "createDerivedAssetReturn",
    ...
    public static class Factory {
         ...
         */
        public static CreateDerivedAssetReturn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CreateDerivedAssetReturn object =
                    new CreateDerivedAssetReturn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"createDerivedAssetReturn".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (CreateDerivedAssetReturn) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
