/**
 * RemoveMetadataSchemaReturn.java
 * <p>
...
/**
 * RemoveMetadataSchemaReturn bean class
 */

public class RemoveMetadataSchemaReturn
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":removeMetadataSchemaReturn",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "removeMetadataSchemaReturn",
    ...
    public static class Factory {
         ...
         */
        public static RemoveMetadataSchemaReturn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RemoveMetadataSchemaReturn object =
                    new RemoveMetadataSchemaReturn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"removeMetadataSchemaReturn".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RemoveMetadataSchemaReturn) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
