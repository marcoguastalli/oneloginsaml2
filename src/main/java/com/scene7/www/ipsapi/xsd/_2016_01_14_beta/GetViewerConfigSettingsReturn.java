/**
 * GetViewerConfigSettingsReturn.java
 * <p>
...
/**
 * GetViewerConfigSettingsReturn bean class
 */

public class GetViewerConfigSettingsReturn
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getViewerConfigSettingsReturn",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getViewerConfigSettingsReturn",
    ...
    public static class Factory {
         ...
         */
        public static GetViewerConfigSettingsReturn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetViewerConfigSettingsReturn object =
                    new GetViewerConfigSettingsReturn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getViewerConfigSettingsReturn".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetViewerConfigSettingsReturn) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
