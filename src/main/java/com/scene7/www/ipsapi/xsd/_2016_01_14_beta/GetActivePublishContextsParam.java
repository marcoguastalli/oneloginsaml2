/**
 * GetActivePublishContextsParam.java
 * <p>
...
/**
 * GetActivePublishContextsParam bean class
 */

public class GetActivePublishContextsParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getActivePublishContextsParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getActivePublishContextsParam",
    ...
    public static class Factory {
         ...
         */
        public static GetActivePublishContextsParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetActivePublishContextsParam object =
                    new GetActivePublishContextsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getActivePublishContextsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetActivePublishContextsParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
