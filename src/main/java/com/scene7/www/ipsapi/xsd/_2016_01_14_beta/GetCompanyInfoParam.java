...
/**
 * GetCompanyInfoParam bean class
 */
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public void setCompanyName(java.lang.String param) {
        this.localCompanyNameTracker = param != null;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getCompanyInfoParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getCompanyInfoParam",
    ...
    public static class Factory {
         ...
         */
        public static GetCompanyInfoParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetCompanyInfoParam object =
                    new GetCompanyInfoParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getCompanyInfoParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetCompanyInfoParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
