...
/**
 * MoveFolderParam bean class
 */

public class MoveFolderParam
    ...
    /**
     * field for DestFolderHandle
     */

    protected java.lang.String localDestFolderHandle;
     ...
     * @return java.lang.String
     */
    public java.lang.String getDestFolderHandle() {
        return this.localDestFolderHandle;
    }

    /**
     * Auto generated setter method
     *
     * @param param DestFolderHandle
     */
    public void setDestFolderHandle(java.lang.String param) {

        this.localDestFolderHandle = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":moveFolderParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "moveFolderParam",
        ...
        namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
        writeStartElement(null, namespace, "destFolderHandle", xmlWriter);

        if (this.localDestFolderHandle == null) {
            // write the nil attribute

            throw new org.apache.axis2.databinding.ADBException("destFolderHandle cannot be null!!");

        } else {

            xmlWriter.writeCharacters(this.localDestFolderHandle);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localDestFolderHandle != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localDestFolderHandle));
        } else {
            throw new org.apache.axis2.databinding.ADBException("destFolderHandle cannot be null!!");
        }
    ...
    public static class Factory {
         ...
         */
        public static MoveFolderParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            MoveFolderParam object =
                    new MoveFolderParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"moveFolderParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (MoveFolderParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "destFolderHandle").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "destFolderHandle" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setDestFolderHandle(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
