...
/**
 * GetPublishContextsParam bean class
 */

public class GetPublishContextsParam
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public boolean isContextTypeSpecified() {
        return this.localContextTypeTracker;
    }
    ...
    public void setContextType(java.lang.String param) {
        this.localContextTypeTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getPublishContextsParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getPublishContextsParam",
        ...
        if (this.localContextTypeTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
    ...
    public static class Factory {
         ...
         */
        public static GetPublishContextsParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetPublishContextsParam object =
                    new GetPublishContextsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getPublishContextsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetPublishContextsParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
