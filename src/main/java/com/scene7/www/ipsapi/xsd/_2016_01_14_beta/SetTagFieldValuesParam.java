...
/**
 * SetTagFieldValuesParam bean class
 */

public class SetTagFieldValuesParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":setTagFieldValuesParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "setTagFieldValuesParam",
    ...
    public static class Factory {
         ...
         */
        public static SetTagFieldValuesParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SetTagFieldValuesParam object =
                    new SetTagFieldValuesParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"setTagFieldValuesParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (SetTagFieldValuesParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
