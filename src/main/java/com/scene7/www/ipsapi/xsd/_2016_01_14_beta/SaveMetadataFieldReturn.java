...
/**
 * SaveMetadataFieldReturn bean class
 */

public class SaveMetadataFieldReturn
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":saveMetadataFieldReturn",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "saveMetadataFieldReturn",
    ...
    public static class Factory {
         ...
         */
        public static SaveMetadataFieldReturn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SaveMetadataFieldReturn object =
                    new SaveMetadataFieldReturn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"saveMetadataFieldReturn".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (SaveMetadataFieldReturn) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
