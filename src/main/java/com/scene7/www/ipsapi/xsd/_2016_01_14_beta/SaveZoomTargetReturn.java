...
/**
 * SaveZoomTargetReturn bean class
 */

public class SaveZoomTargetReturn
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":saveZoomTargetReturn",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "saveZoomTargetReturn",
    ...
    public static class Factory {
         ...
         */
        public static SaveZoomTargetReturn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SaveZoomTargetReturn object =
                    new SaveZoomTargetReturn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"saveZoomTargetReturn".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (SaveZoomTargetReturn) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
