/**
 * GetAssetPublishHistoryParam.java
 * <p>
...
/**
 * GetAssetPublishHistoryParam bean class
 */

public class GetAssetPublishHistoryParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getAssetPublishHistoryParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getAssetPublishHistoryParam",
    ...
    public static class Factory {
         ...
         */
        public static GetAssetPublishHistoryParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetAssetPublishHistoryParam object =
                    new GetAssetPublishHistoryParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getAssetPublishHistoryParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetAssetPublishHistoryParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
