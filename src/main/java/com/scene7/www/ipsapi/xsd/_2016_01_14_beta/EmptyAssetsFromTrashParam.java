/**
 * EmptyAssetsFromTrashParam.java
 * <p>
...
/**
 * EmptyAssetsFromTrashParam bean class
 */

public class EmptyAssetsFromTrashParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":emptyAssetsFromTrashParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "emptyAssetsFromTrashParam",
    ...
    public static class Factory {
         ...
         */
        public static EmptyAssetsFromTrashParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            EmptyAssetsFromTrashParam object =
                    new EmptyAssetsFromTrashParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"emptyAssetsFromTrashParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (EmptyAssetsFromTrashParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
