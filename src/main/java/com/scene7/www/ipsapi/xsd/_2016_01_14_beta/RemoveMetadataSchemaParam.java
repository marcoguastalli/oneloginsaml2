/**
 * RemoveMetadataSchemaParam.java
 * <p>
...
/**
 * RemoveMetadataSchemaParam bean class
 */

public class RemoveMetadataSchemaParam
    ...
    /**
     * field for SchemaNamespace
     */

    protected java.lang.String localSchemaNamespace;
    ...
    public java.lang.String getSchemaNamespace() {
        return this.localSchemaNamespace;
    }

    /**
     * Auto generated setter method
     *
     * @param param SchemaNamespace
     */
    public void setSchemaNamespace(java.lang.String param) {

        this.localSchemaNamespace = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":removeMetadataSchemaParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "removeMetadataSchemaParam",
        ...
        namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
        writeStartElement(null, namespace, "schemaNamespace", xmlWriter);

        if (this.localSchemaNamespace == null) {
            // write the nil attribute

            throw new org.apache.axis2.databinding.ADBException("schemaNamespace cannot be null!!");

        } else {

            xmlWriter.writeCharacters(this.localSchemaNamespace);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localSchemaNamespace != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localSchemaNamespace));
        } else {
            throw new org.apache.axis2.databinding.ADBException("schemaNamespace cannot be null!!");
        }
    ...
    public static class Factory {
         ...
         */
        public static RemoveMetadataSchemaParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RemoveMetadataSchemaParam object =
                    new RemoveMetadataSchemaParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"removeMetadataSchemaParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RemoveMetadataSchemaParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "schemaNamespace").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "schemaNamespace" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setSchemaNamespace(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
