/**
 * SetAssetPublishStateParam.java
 * <p>
...
/**
 * SetAssetPublishStateParam bean class
 */

public class SetAssetPublishStateParam
    ...
    /**
     * field for ContextHandleArray
     */

    protected com.scene7.www.ipsapi.xsd._2016_01_14_beta.HandleArray localContextHandleArray;
    /*  This tracker boolean wil be used to detect whether the user called the set method
   *   for this attribute. It will be used to determine whether to include this field
    *   in the serialized XML
    */
    protected boolean localContextHandleArrayTracker = false;
    ...
    public boolean isContextHandleArraySpecified() {
        return this.localContextHandleArrayTracker;
    }
     ...
     */
    public com.scene7.www.ipsapi.xsd._2016_01_14_beta.HandleArray getContextHandleArray() {
        return this.localContextHandleArray;
    }

    /**
     * Auto generated setter method
     *
     * @param param ContextHandleArray
     */
    public void setContextHandleArray(com.scene7.www.ipsapi.xsd._2016_01_14_beta.HandleArray param) {
        this.localContextHandleArrayTracker = param != null;

        this.localContextHandleArray = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":setAssetPublishStateParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "setAssetPublishStateParam",
        ...
        xmlWriter.writeEndElement();
        if (this.localContextHandleArrayTracker) {
            if (this.localContextHandleArray == null) {
                throw new org.apache.axis2.databinding.ADBException("contextHandleArray cannot be null!!");
            }
            this.localContextHandleArray
                    .serialize(new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "contextHandleArray"),
                            xmlWriter);
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localContextHandleArrayTracker) {
            ...
            elementList.add(this.localContextHandleArray);
        }
    ...
    public static class Factory {
         ...
         */
        public static SetAssetPublishStateParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SetAssetPublishStateParam object =
                    new SetAssetPublishStateParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"setAssetPublishStateParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (SetAssetPublishStateParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "contextHandleArray").equals(reader.getName())) {

                    object.setContextHandleArray(com.scene7.www.ipsapi.xsd._2016_01_14_beta.HandleArray.Factory.parse(reader));
