...
/**
 * CreateDerivedAssetParam bean class
 */

public class CreateDerivedAssetParam
    ...
    /**
     * field for OwnerHandle
     */

    protected java.lang.String localOwnerHandle;
    /**
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public java.lang.String getOwnerHandle() {
        return this.localOwnerHandle;
    }

    /**
     * Auto generated setter method
     *
     * @param param OwnerHandle
     */
    public void setOwnerHandle(java.lang.String param) {

        this.localOwnerHandle = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":createDerivedAssetParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "createDerivedAssetParam",
        ...
        namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
        writeStartElement(null, namespace, "ownerHandle", xmlWriter);

        if (this.localOwnerHandle == null) {
            // write the nil attribute

            throw new org.apache.axis2.databinding.ADBException("ownerHandle cannot be null!!");

        } else {

            xmlWriter.writeCharacters(this.localOwnerHandle);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localOwnerHandle != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localOwnerHandle));
        } else {
            throw new org.apache.axis2.databinding.ADBException("ownerHandle cannot be null!!");
        }
    ...
    public static class Factory {
         ...
         */
        public static CreateDerivedAssetParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CreateDerivedAssetParam object =
                    new CreateDerivedAssetParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"createDerivedAssetParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (CreateDerivedAssetParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "ownerHandle").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "ownerHandle" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setOwnerHandle(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
