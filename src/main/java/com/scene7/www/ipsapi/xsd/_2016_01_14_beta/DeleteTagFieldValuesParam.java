/**
 * DeleteTagFieldValuesParam.java
 * <p>
...
/**
 * DeleteTagFieldValuesParam bean class
 */

public class DeleteTagFieldValuesParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":deleteTagFieldValuesParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "deleteTagFieldValuesParam",
    ...
    public static class Factory {
         ...
         */
        public static DeleteTagFieldValuesParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DeleteTagFieldValuesParam object =
                    new DeleteTagFieldValuesParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"deleteTagFieldValuesParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DeleteTagFieldValuesParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
