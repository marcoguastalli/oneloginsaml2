...
/**
 *  UpdateXMPPacketReturn bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class UpdateXMPPacketReturn
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":updateXMPPacketReturn",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "updateXMPPacketReturn",
    ...
    public static class Factory {
         ...
         */
        public static UpdateXMPPacketReturn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateXMPPacketReturn object =
                    new UpdateXMPPacketReturn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateXMPPacketReturn".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (UpdateXMPPacketReturn) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
