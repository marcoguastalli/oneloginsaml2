...
/**
 *  UpdateMetadataFieldParam bean class
 */
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public boolean isInitialTagValueSpecified() {
        return localInitialTagValueTracker;
    }
    ...
    public void setInitialTagValue(java.lang.String param) {
        localInitialTagValueTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":updateMetadataFieldParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "updateMetadataFieldParam",
        ...
        if (localIsHiddenTracker) {
            ...
            if (false) {
                ...
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsHidden));
            }

            xmlWriter.writeEndElement();
        }
        if (localIsEnforcedTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            ...
            if (false) {
                ...
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsEnforced));
            }

            xmlWriter.writeEndElement();
        }
        if (localInitialTagValueTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            writeStartElement(null, namespace, "initialTagValue", xmlWriter);

            if (localInitialTagValue == null) {
                // write the nil attribute
                ...
                xmlWriter.writeCharacters(localInitialTagValue);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localIsHiddenTracker) {
            ...
            elementList.add(
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsHidden));
        }
        if (localIsEnforcedTracker) {
            elementList.add(new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                    "isEnforced"));
            ...
            elementList.add(
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsEnforced));
        }
        if (localInitialTagValueTracker) {
            elementList.add(new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                    "initialTagValue"));
            ...
            if (localInitialTagValue != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localInitialTagValue));
            } else {
                throw new org.apache.axis2.databinding.ADBException("initialTagValue cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UpdateMetadataFieldParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateMetadataFieldParam object =
                    new UpdateMetadataFieldParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateMetadataFieldParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (UpdateMetadataFieldParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
