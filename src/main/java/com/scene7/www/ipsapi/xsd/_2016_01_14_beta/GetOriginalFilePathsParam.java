/**
 * GetOriginalFilePathsParam.java
 * <p>
...
/**
 * GetOriginalFilePathsParam bean class
 */

public class GetOriginalFilePathsParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getOriginalFilePathsParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getOriginalFilePathsParam",
    ...
    public static class Factory {
         ...
         */
        public static GetOriginalFilePathsParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetOriginalFilePathsParam object =
                    new GetOriginalFilePathsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getOriginalFilePathsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetOriginalFilePathsParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
