...
/**
 * IccProfileFieldUpdate bean class
 */

public class IccProfileFieldUpdate
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = IccProfileFieldUpdate
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    protected java.lang.String localPcsType;
    /*  This tracker boolean wil be used to detect whether the user called the set method
   *   for this attribute. It will be used to determine whether to include this field
    *   in the serialized XML
    */
    protected boolean localPcsTypeTracker = false;
    ...
    public boolean is_classSpecified() {
        return this.local_classTracker;
    }
    ...
    public void set_class(java.lang.String param) {
        this.local_classTracker = param != null;
    ...
    public boolean isPcsTypeSpecified() {
        return this.localPcsTypeTracker;
    }
     ...
     * @param param PcsType
     */
    public void setPcsType(java.lang.String param) {
        this.localPcsTypeTracker = param != null;

        this.localPcsType = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":IccProfileFieldUpdate",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (this.local_classTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            writeStartElement(null, namespace, "class", xmlWriter);

            if (this.local_class == null) {
                // write the nil attribute
                ...
                xmlWriter.writeCharacters(this.local_class);
        ...
        if (this.localPcsTypeTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            writeStartElement(null, namespace, "pcsType", xmlWriter);

            if (this.localPcsType == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("pcsType cannot be null!!");

            } else {

                xmlWriter.writeCharacters(this.localPcsType);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.local_classTracker) {
            ...
            if (this.local_class != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.local_class));
            } else {
                throw new org.apache.axis2.databinding.ADBException("class cannot be null!!");
            }
        }
        ...
        if (this.localPcsTypeTracker) {
            ...
            if (this.localPcsType != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localPcsType));
            } else {
                throw new org.apache.axis2.databinding.ADBException("pcsType cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static IccProfileFieldUpdate parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            IccProfileFieldUpdate object =
                    new IccProfileFieldUpdate();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"IccProfileFieldUpdate".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (IccProfileFieldUpdate) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "class")
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "pcsType")
                        .equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "pcsType" + "  cannot be null");
                    }
