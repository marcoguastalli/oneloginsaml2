/**
 * CreateVignettePublishFormatReturn.java
 * <p>
...
/**
 * CreateVignettePublishFormatReturn bean class
 */

public class CreateVignettePublishFormatReturn
    ...
    public java.lang.String getVignetteFormatHandle() {
        return this.localVignetteFormatHandle;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":createVignettePublishFormatReturn",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "createVignettePublishFormatReturn",
        ...
        if (this.localVignetteFormatHandle == null) {
            ...
            xmlWriter.writeCharacters(this.localVignetteFormatHandle);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localVignetteFormatHandle != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localVignetteFormatHandle));
        } else {
            throw new org.apache.axis2.databinding.ADBException("vignetteFormatHandle cannot be null!!");
        }
    ...
    public static class Factory {
         ...
         */
        public static CreateVignettePublishFormatReturn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CreateVignettePublishFormatReturn object =
                    new CreateVignettePublishFormatReturn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"createVignettePublishFormatReturn".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (CreateVignettePublishFormatReturn) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper
                                    .getTypeObject(
                                            nsUri, type, reader);
                        }
