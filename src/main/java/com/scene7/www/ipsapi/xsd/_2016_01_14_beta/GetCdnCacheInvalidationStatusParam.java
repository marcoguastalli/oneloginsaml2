/**
 * GetCdnCacheInvalidationStatusParam.java
 * <p>
...
/**
 * GetCdnCacheInvalidationStatusParam bean class
 */

public class GetCdnCacheInvalidationStatusParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getCdnCacheInvalidationStatusParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getCdnCacheInvalidationStatusParam",
    ...
    public static class Factory {
         ...
         */
        public static GetCdnCacheInvalidationStatusParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetCdnCacheInvalidationStatusParam object =
                    new GetCdnCacheInvalidationStatusParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getCdnCacheInvalidationStatusParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetCdnCacheInvalidationStatusParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper
                                    .getTypeObject(
                                            nsUri, type, reader);
                        }
