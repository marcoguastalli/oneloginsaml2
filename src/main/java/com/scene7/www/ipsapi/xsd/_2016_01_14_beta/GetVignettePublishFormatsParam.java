/**
 * GetVignettePublishFormatsParam.java
 * <p>
...
/**
 * GetVignettePublishFormatsParam bean class
 */

public class GetVignettePublishFormatsParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getVignettePublishFormatsParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getVignettePublishFormatsParam",
    ...
    public static class Factory {
         ...
         */
        public static GetVignettePublishFormatsParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetVignettePublishFormatsParam object =
                    new GetVignettePublishFormatsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getVignettePublishFormatsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetVignettePublishFormatsParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper
                                    .getTypeObject(
                                            nsUri, type, reader);
                        }
