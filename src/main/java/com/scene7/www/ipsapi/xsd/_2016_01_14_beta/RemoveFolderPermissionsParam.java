/**
 * RemoveFolderPermissionsParam.java
 * <p>
...
/**
 * RemoveFolderPermissionsParam bean class
 */

public class RemoveFolderPermissionsParam
    ...
    public boolean getUpdateChildren() {
        return this.localUpdateChildren;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":removeFolderPermissionsParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "removeFolderPermissionsParam",
        ...
        if (false) {
            ...
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localUpdateChildren));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localUpdateChildren));
    ...
    public static class Factory {
         ...
         */
        public static RemoveFolderPermissionsParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RemoveFolderPermissionsParam object =
                    new RemoveFolderPermissionsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"removeFolderPermissionsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RemoveFolderPermissionsParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
