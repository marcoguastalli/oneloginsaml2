...
/**
 * ListCompanyMetadataParam bean class
 */

public class ListCompanyMetadataParam
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    protected boolean localXtypeTracker = false;
    ...
    public boolean isXtypeSpecified() {
        return this.localXtypeTracker;
    }
    ...
    public void setXtype(java.lang.String param) {
        this.localXtypeTracker = param != null;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":listCompanyMetadataParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "listCompanyMetadataParam",
    ...
    public static class Factory {
         ...
         */
        public static ListCompanyMetadataParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ListCompanyMetadataParam object =
                    new ListCompanyMetadataParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"listCompanyMetadataParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ListCompanyMetadataParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
