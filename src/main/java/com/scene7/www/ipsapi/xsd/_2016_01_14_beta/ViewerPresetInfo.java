   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public boolean isConfigSettingArraySpecified() {
        return localConfigSettingArrayTracker;
    }
    ...
    public void setConfigSettingArray(com.scene7.www.ipsapi.xsd._2016_01_14_beta.ConfigSettingArray param) {
        localConfigSettingArrayTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ViewerPresetInfo",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ViewerPresetInfo",
        ...
        if (localConfigSettingArrayTracker) {
    ...
    public static class Factory {
         ...
         */
        public static ViewerPresetInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ViewerPresetInfo object =
                    new ViewerPresetInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ViewerPresetInfo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ViewerPresetInfo) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
