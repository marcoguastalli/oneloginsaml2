...
public class ActiveJob
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    /**
     * field for TriggerTime
     */

    protected java.util.Calendar localTriggerTime;
    /**
     * field for TotalSize
     */

    protected int localTotalSize;
    /**
     * field for Progress
     */

    protected int localProgress;
    /**
    ...
    /**
     * field for TaskProgressArray
     */

    protected com.scene7.www.ipsapi.xsd._2016_01_14_beta.TaskProgressArray localTaskProgressArray;
    /**
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    /**
     * field for UploadPostJob
     */

    protected com.scene7.www.ipsapi.xsd._2016_01_14_beta.UploadPostJob localUploadPostJob;
    /*  This tracker boolean wil be used to detect whether the user called the set method
   *   for this attribute. It will be used to determine whether to include this field
    *   in the serialized XML
    */
    protected boolean localUploadPostJobTracker = false;
    /**
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
     ...
     * @return java.util.Calendar
     */
    public java.util.Calendar getTriggerTime() {
        return this.localTriggerTime;
    }

    /**
     * Auto generated setter method
     *
     * @param param TriggerTime
     */
    public void setTriggerTime(java.util.Calendar param) {

        this.localTriggerTime = param;
     ...
     */
    public void setTotalSize(int param) {
     ...
     * Auto generated getter method
     *
     * @return com.scene7.www.ipsapi.xsd._2016_01_14_beta.TaskProgressArray
     */
    public com.scene7.www.ipsapi.xsd._2016_01_14_beta.TaskProgressArray getTaskProgressArray() {
        return this.localTaskProgressArray;
    }

    /**
     * Auto generated setter method
     *
     * @param param TaskProgressArray
     */
    public void setTaskProgressArray(com.scene7.www.ipsapi.xsd._2016_01_14_beta.TaskProgressArray param) {

        this.localTaskProgressArray = param;
    ...
    public boolean isUploadPostJobSpecified() {
        return this.localUploadPostJobTracker;
    }
     ...
     */
    public com.scene7.www.ipsapi.xsd._2016_01_14_beta.UploadPostJob getUploadPostJob() {
        return this.localUploadPostJob;
    }

    /**
     * Auto generated setter method
     *
     * @param param UploadPostJob
     */
    public void setUploadPostJob(com.scene7.www.ipsapi.xsd._2016_01_14_beta.UploadPostJob param) {
        this.localUploadPostJobTracker = param != null;

        this.localUploadPostJob = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (this.localState == null) {
            ...
            xmlWriter.writeCharacters(this.localState);
        ...
        if (this.localServerName == null) {
            ...
            throw new org.apache.axis2.databinding.ADBException("serverName cannot be null!!");

        } else {

            xmlWriter.writeCharacters(this.localServerName);
        ...
        namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
        writeStartElement(null, namespace, "triggerTime", xmlWriter);

        if (this.localTriggerTime == null) {
            // write the nil attribute

            throw new org.apache.axis2.databinding.ADBException("triggerTime cannot be null!!");

        } else {

            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localTriggerTime));
        ...
        if (this.localTotalSize == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("totalSize cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localTotalSize));
        }
        ...
        if (this.localProgress == java.lang.Integer.MIN_VALUE) {
        ...
        if (this.localTaskProgressArray == null) {
            throw new org.apache.axis2.databinding.ADBException("taskProgressArray cannot be null!!");
        }
        this.localTaskProgressArray
                .serialize(new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "taskProgressArray"),
                        xmlWriter);
        ...
        if (this.localUploadPostJobTracker) {
            if (this.localUploadPostJob == null) {
                throw new org.apache.axis2.databinding.ADBException("uploadPostJob cannot be null!!");
            }
            this.localUploadPostJob
                    .serialize(new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "uploadPostJob"),
                            xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localState != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localState));
        } else {
            throw new org.apache.axis2.databinding.ADBException("state cannot be null!!");
        }
        ...
        if (this.localServerName != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localServerName));
        } else {
            throw new org.apache.axis2.databinding.ADBException("serverName cannot be null!!");
        }
        ...
        if (this.localTriggerTime != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localTriggerTime));
        } else {
            throw new org.apache.axis2.databinding.ADBException("triggerTime cannot be null!!");
        }
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localTotalSize));
        ...
        elementList.add(this.localTaskProgressArray);
        if (this.localImageServingPublishJobTracker) {
            elementList.add(new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
        ...
        if (this.localUploadPostJobTracker) {
            ...
            elementList.add(this.localUploadPostJob);
        }
        if (this.localOptimizeImagesJobTracker) {
            elementList.add(new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                    "optimizeImagesJob"));
    ...
    public static class Factory {
         ...
         */
        public static ActiveJob parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ActiveJob object =
                    new ActiveJob();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ActiveJob".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ActiveJob) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "state")
                        .equals(reader.getName())) {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "serverName").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "serverName" + "  cannot be null");
                    }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "triggerTime").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "triggerTime" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setTriggerTime(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "totalSize").equals(reader.getName())) {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "taskProgressArray").equals(reader.getName())) {

                    object.setTaskProgressArray(com.scene7.www.ipsapi.xsd._2016_01_14_beta.TaskProgressArray.Factory.parse(reader));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "uploadPostJob").equals(reader.getName())) {

                    object.setUploadPostJob(com.scene7.www.ipsapi.xsd._2016_01_14_beta.UploadPostJob.Factory.parse(reader));
