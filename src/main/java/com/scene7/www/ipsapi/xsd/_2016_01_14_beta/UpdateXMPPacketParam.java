...
/**
 *  UpdateXMPPacketParam bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class UpdateXMPPacketParam
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":updateXMPPacketParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "updateXMPPacketParam",
        ...
        if (localCompressedPacket != null) {
            try {
                org.apache.axiom.util.stax.XMLStreamWriterUtils.writeDataHandler(xmlWriter, localCompressedPacket, null, true);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(localCompressedPacket);
    ...
    public static class Factory {
         ...
         */
        public static UpdateXMPPacketParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateXMPPacketParam object =
                    new UpdateXMPPacketParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateXMPPacketParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (UpdateXMPPacketParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
