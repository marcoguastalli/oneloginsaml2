   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public boolean isAssetNameSpecified() {
        return this.localAssetNameTracker;
    }
    ...
    public void setAssetName(java.lang.String param) {
        this.localAssetNameTracker = param != null;
    ...
    public boolean isAssetTypeSpecified() {
        return this.localAssetTypeTracker;
    }
    ...
    public void setAssetType(java.lang.String param) {
        this.localAssetTypeTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (this.localDateCreated == null) {
            ...
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localDateCreated));

        }

        xmlWriter.writeEndElement();
        if (this.localAssetNameTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            writeStartElement(null, namespace, "assetName", xmlWriter);

            if (this.localAssetName == null) {
                // write the nil attribute
                ...
                xmlWriter.writeCharacters(this.localAssetName);

            }

            xmlWriter.writeEndElement();
        }
        if (this.localAssetTypeTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localDateCreated != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localDateCreated));
        } else {
            throw new org.apache.axis2.databinding.ADBException("dateCreated cannot be null!!");
        }
        if (this.localAssetNameTracker) {
            ...
            if (this.localAssetName != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localAssetName));
            } else {
                throw new org.apache.axis2.databinding.ADBException("assetName cannot be null!!");
            }
        }
    ...
    public static class Factory {
        ...
        public static JobLogDetail parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"JobLogDetail".equals(type)) {
                            ...
                            return (JobLogDetail) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "assetName").equals(reader.getName())) {
