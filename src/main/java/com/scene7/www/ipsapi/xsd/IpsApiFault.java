...
/**
 *  IpsApiFault bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class IpsApiFault
    ...
    public static class Factory {
         ...
         */
        public static IpsApiFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            IpsApiFault object =
                    new IpsApiFault();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ipsApiFault".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (IpsApiFault) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
