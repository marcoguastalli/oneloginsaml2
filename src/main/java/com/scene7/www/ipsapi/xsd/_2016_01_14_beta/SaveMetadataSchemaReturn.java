...
/**
 * SaveMetadataSchemaReturn bean class
 */

public class SaveMetadataSchemaReturn
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":saveMetadataSchemaReturn",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "saveMetadataSchemaReturn",
    ...
    public static class Factory {
         ...
         */
        public static SaveMetadataSchemaReturn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SaveMetadataSchemaReturn object =
                    new SaveMetadataSchemaReturn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"saveMetadataSchemaReturn".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (SaveMetadataSchemaReturn) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
