...
/**
 * IllustratorOptions bean class
 */

public class IllustratorOptions
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = IllustratorOptions
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    protected boolean localAlpha;
    /*  This tracker boolean wil be used to detect whether the user called the set method
   *   for this attribute. It will be used to determine whether to include this field
    *   in the serialized XML
    */
    protected boolean localAlphaTracker = false;
    ...
    public boolean isAlphaSpecified() {
        return this.localAlphaTracker;
    }
     ...
     * @param param Alpha
     */
    public void setAlpha(boolean param) {

        // setting primitive attribute tracker to true
        this.localAlphaTracker =
                true;

        this.localAlpha = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":IllustratorOptions",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "IllustratorOptions",
        ...
        if (this.localAlphaTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            writeStartElement(null, namespace, "alpha", xmlWriter);

            if (false) {

                throw new org.apache.axis2.databinding.ADBException("alpha cannot be null!!");

            } else {
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localAlpha));
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localAlphaTracker) {
            ...
            elementList.add(
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localAlpha));
        }
    ...
    public static class Factory {
         ...
         */
        public static IllustratorOptions parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            IllustratorOptions object =
                    new IllustratorOptions();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"IllustratorOptions".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (IllustratorOptions) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "alpha")
                        .equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "alpha" + "  cannot be null");
                    }
