/**
 * SetViewerConfigSettingsParam.java
 * <p>
...
/**
 * SetViewerConfigSettingsParam bean class
 */

public class SetViewerConfigSettingsParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":setViewerConfigSettingsParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "setViewerConfigSettingsParam",
    ...
    public static class Factory {
         ...
         */
        public static SetViewerConfigSettingsParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SetViewerConfigSettingsParam object =
                    new SetViewerConfigSettingsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"setViewerConfigSettingsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (SetViewerConfigSettingsParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
