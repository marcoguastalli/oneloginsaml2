...
/**
 * CreateAssetSetParam bean class
 */

public class CreateAssetSetParam
    ...
    /**
     * field for SetDefinition
     */

    protected java.lang.String localSetDefinition;
    /*  This tracker boolean wil be used to detect whether the user called the set method
   *   for this attribute. It will be used to determine whether to include this field
    *   in the serialized XML
    */
    protected boolean localSetDefinitionTracker = false;
    /**
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public boolean isSetDefinitionSpecified() {
        return this.localSetDefinitionTracker;
    }
    ...
    public java.lang.String getSetDefinition() {
        return this.localSetDefinition;
    }

    /**
     * Auto generated setter method
     *
     * @param param SetDefinition
     */
    public void setSetDefinition(java.lang.String param) {
        this.localSetDefinitionTracker = param != null;

        this.localSetDefinition = param;

    }

    public boolean isThumbAssetHandleSpecified() {
        return this.localThumbAssetHandleTracker;
    }
    ...
    public java.lang.String getThumbAssetHandle() {
        return this.localThumbAssetHandle;
    }
    ...
    public void setThumbAssetHandle(java.lang.String param) {
        this.localThumbAssetHandleTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":createAssetSetParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "createAssetSetParam",
        ...
        xmlWriter.writeEndElement();
        if (this.localSetDefinitionTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            writeStartElement(null, namespace, "setDefinition", xmlWriter);

            if (this.localSetDefinition == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("setDefinition cannot be null!!");

            } else {

                xmlWriter.writeCharacters(this.localSetDefinition);

            }

            xmlWriter.writeEndElement();
        }
        if (this.localThumbAssetHandleTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            writeStartElement(null, namespace, "thumbAssetHandle", xmlWriter);

            if (this.localThumbAssetHandle == null) {
                // write the nil attribute
                ...
                xmlWriter.writeCharacters(this.localThumbAssetHandle);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localSetDefinitionTracker) {
            ...
            if (this.localSetDefinition != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localSetDefinition));
            } else {
                throw new org.apache.axis2.databinding.ADBException("setDefinition cannot be null!!");
            }
        }
        if (this.localThumbAssetHandleTracker) {
            ...
            if (this.localThumbAssetHandle != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localThumbAssetHandle));
            } else {
                throw new org.apache.axis2.databinding.ADBException("thumbAssetHandle cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CreateAssetSetParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CreateAssetSetParam object =
                    new CreateAssetSetParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"createAssetSetParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (CreateAssetSetParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "setDefinition").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "setDefinition" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setSetDefinition(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
