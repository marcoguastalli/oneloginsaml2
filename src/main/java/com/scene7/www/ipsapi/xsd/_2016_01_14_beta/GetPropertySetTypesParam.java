...
/**
 * GetPropertySetTypesParam bean class
 */

public class GetPropertySetTypesParam
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getPropertySetTypesParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getPropertySetTypesParam",
    ...
    public static class Factory {
         ...
         */
        public static GetPropertySetTypesParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetPropertySetTypesParam object =
                    new GetPropertySetTypesParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getPropertySetTypesParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetPropertySetTypesParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
