   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public boolean isDateCreatedSpecified() {
        return this.localDateCreatedTracker;
    }
    ...
    public void setDateCreated(java.util.Calendar param) {
        this.localDateCreatedTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":JobLogDetailAux",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "JobLogDetailAux",
        ...
        xmlWriter.writeEndElement();
        if (this.localDateCreatedTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
    ...
    public static class Factory {
         ...
         */
        public static JobLogDetailAux parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            JobLogDetailAux object =
                    new JobLogDetailAux();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"JobLogDetailAux".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (JobLogDetailAux) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
