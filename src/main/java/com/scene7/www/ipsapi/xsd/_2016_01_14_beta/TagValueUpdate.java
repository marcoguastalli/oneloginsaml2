...
public class TagValueUpdate
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":TagValueUpdate",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "TagValueUpdate",
        ...
        if (this.localOldValue == null) {
            ...
            xmlWriter.writeCharacters(this.localOldValue);
        ...
        if (this.localNewValue == null) {
            ...
            xmlWriter.writeCharacters(this.localNewValue);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localOldValue != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localOldValue));
        } else {
            throw new org.apache.axis2.databinding.ADBException("oldValue cannot be null!!");
        }
        ...
        if (this.localNewValue != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localNewValue));
        } else {
            throw new org.apache.axis2.databinding.ADBException("newValue cannot be null!!");
        }
    ...
    public static class Factory {
         ...
         */
        public static TagValueUpdate parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TagValueUpdate object =
                    new TagValueUpdate();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TagValueUpdate".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (TagValueUpdate) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "oldValue")
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "newValue")
                        .equals(reader.getName())) {
