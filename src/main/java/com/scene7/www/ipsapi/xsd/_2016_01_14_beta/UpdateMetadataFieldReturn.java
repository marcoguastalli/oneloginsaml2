/**
 * UpdateMetadataFieldReturn.java
 * <p>
...
/**
 *  UpdateMetadataFieldReturn bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class UpdateMetadataFieldReturn
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":updateMetadataFieldReturn",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "updateMetadataFieldReturn",
    ...
    public static class Factory {
         ...
         */
        public static UpdateMetadataFieldReturn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateMetadataFieldReturn object =
                    new UpdateMetadataFieldReturn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateMetadataFieldReturn".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (UpdateMetadataFieldReturn) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
