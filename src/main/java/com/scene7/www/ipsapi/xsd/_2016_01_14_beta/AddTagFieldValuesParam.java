...
/**
 * AddTagFieldValuesParam bean class
 */
...
public class AddTagFieldValuesParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":addTagFieldValuesParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "addTagFieldValuesParam",
    ...
    public static class Factory {
         ...
         */
        public static AddTagFieldValuesParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AddTagFieldValuesParam object =
                    new AddTagFieldValuesParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"addTagFieldValuesParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (AddTagFieldValuesParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
