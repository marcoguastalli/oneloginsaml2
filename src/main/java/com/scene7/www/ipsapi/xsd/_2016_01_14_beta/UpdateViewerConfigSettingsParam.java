/**
 * UpdateViewerConfigSettingsParam.java
 * <p>
...
/**
 *  UpdateViewerConfigSettingsParam bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class UpdateViewerConfigSettingsParam
    ...
    public com.scene7.www.ipsapi.xsd._2016_01_14_beta.ConfigSettingArray getConfigSettingArray() {
        return localConfigSettingArray;
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":updateViewerConfigSettingsParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "updateViewerConfigSettingsParam",
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(localConfigSettingArray);
    ...
    public static class Factory {
         ...
         */
        public static UpdateViewerConfigSettingsParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateViewerConfigSettingsParam object =
                    new UpdateViewerConfigSettingsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateViewerConfigSettingsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (UpdateViewerConfigSettingsParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper
                                    .getTypeObject(
                                            nsUri, type, reader);
                        }
