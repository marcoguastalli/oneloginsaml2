   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public void setUrl(java.lang.String param) {
        this.localUrlTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (this.localUrlTracker) {
            ...
            if (this.localUrl == null) {
                ...
                xmlWriter.writeCharacters(this.localUrl);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localUrlTracker) {
            ...
            if (this.localUrl != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localUrl));
            } else {
                throw new org.apache.axis2.databinding.ADBException("url cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static LayerViewInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            LayerViewInfo object =
                    new LayerViewInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"LayerViewInfo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (LayerViewInfo) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
