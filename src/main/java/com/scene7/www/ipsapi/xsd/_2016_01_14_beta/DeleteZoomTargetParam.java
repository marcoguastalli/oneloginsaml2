...
/**
 * DeleteZoomTargetParam bean class
 */

public class DeleteZoomTargetParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":deleteZoomTargetParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "deleteZoomTargetParam",
    ...
    public static class Factory {
         ...
         */
        public static DeleteZoomTargetParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DeleteZoomTargetParam object =
                    new DeleteZoomTargetParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"deleteZoomTargetParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DeleteZoomTargetParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
