/**
 * GetUniqueMetadataValuesParam.java
 * <p>
...
/**
 * GetUniqueMetadataValuesParam bean class
 */

public class GetUniqueMetadataValuesParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getUniqueMetadataValuesParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getUniqueMetadataValuesParam",
    ...
    public static class Factory {
         ...
         */
        public static GetUniqueMetadataValuesParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetUniqueMetadataValuesParam object =
                    new GetUniqueMetadataValuesParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getUniqueMetadataValuesParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetUniqueMetadataValuesParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
