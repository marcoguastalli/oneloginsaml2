...
/**
 * GetMetadataSchemaParam bean class
 */

public class GetMetadataSchemaParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getMetadataSchemaParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getMetadataSchemaParam",
    ...
    public static class Factory {
         ...
         */
        public static GetMetadataSchemaParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetMetadataSchemaParam object =
                    new GetMetadataSchemaParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getMetadataSchemaParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetMetadataSchemaParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
