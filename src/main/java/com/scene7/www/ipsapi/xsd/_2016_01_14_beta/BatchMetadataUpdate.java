...
/**
 * BatchMetadataUpdate bean class
 */
...
public class BatchMetadataUpdate
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":BatchMetadataUpdate",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "BatchMetadataUpdate",
    ...
    public static class Factory {
         ...
         */
        public static BatchMetadataUpdate parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            BatchMetadataUpdate object =
                    new BatchMetadataUpdate();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"BatchMetadataUpdate".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (BatchMetadataUpdate) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
