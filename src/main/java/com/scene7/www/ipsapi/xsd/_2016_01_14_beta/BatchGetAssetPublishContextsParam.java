/**
 * BatchGetAssetPublishContextsParam.java
 * <p>
...
/**
 * BatchGetAssetPublishContextsParam bean class
 */

public class BatchGetAssetPublishContextsParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":batchGetAssetPublishContextsParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "batchGetAssetPublishContextsParam",
    ...
    public static class Factory {
         ...
         */
        public static BatchGetAssetPublishContextsParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            BatchGetAssetPublishContextsParam object =
                    new BatchGetAssetPublishContextsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"batchGetAssetPublishContextsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (BatchGetAssetPublishContextsParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper
                                    .getTypeObject(
                                            nsUri, type, reader);
                        }
