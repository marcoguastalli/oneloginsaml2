   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public boolean isImagePathSpecified() {
        return this.localImagePathTracker;
    }
    ...
    public void setImagePath(java.lang.String param) {
        this.localImagePathTracker = param != null;
    ...
    public boolean isImageFileSpecified() {
        return this.localImageFileTracker;
    }
    ...
    public void setImageFile(java.lang.String param) {
        this.localImageFileTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (this.localImagePathTracker) {
            ...
            if (this.localImagePath == null) {
                ...
                xmlWriter.writeCharacters(this.localImagePath);

            }

            xmlWriter.writeEndElement();
        }
        if (this.localImageFileTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            ...
            if (this.localImageFile == null) {
                ...
                xmlWriter.writeCharacters(this.localImageFile);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localImagePathTracker) {
            ...
            if (this.localImagePath != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localImagePath));
            } else {
                throw new org.apache.axis2.databinding.ADBException("imagePath cannot be null!!");
            }
        }
        if (this.localImageFileTracker) {
            ...
            if (this.localImageFile != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localImageFile));
            } else {
                throw new org.apache.axis2.databinding.ADBException("imageFile cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CabinetInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CabinetInfo object =
                    new CabinetInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CabinetInfo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (CabinetInfo) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
