...
/**
 * GetActiveJobsParam bean class
 */

public class GetActiveJobsParam
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    /**
     * field for IncludeWaitingJobs
     */

    protected boolean localIncludeWaitingJobs;
    /*  This tracker boolean wil be used to detect whether the user called the set method
   *   for this attribute. It will be used to determine whether to include this field
    *   in the serialized XML
    */
    protected boolean localIncludeWaitingJobsTracker = false;
    ...
    public boolean isIncludeWaitingJobsSpecified() {
        return this.localIncludeWaitingJobsTracker;
    }
     ...
     * @return boolean
     */
    public boolean getIncludeWaitingJobs() {
        return this.localIncludeWaitingJobs;
    }

    /**
     * Auto generated setter method
     *
     * @param param IncludeWaitingJobs
     */
    public void setIncludeWaitingJobs(boolean param) {

        // setting primitive attribute tracker to true
        this.localIncludeWaitingJobsTracker =
                true;

        this.localIncludeWaitingJobs = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getActiveJobsParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getActiveJobsParam",
        ...
        if (this.localIncludeWaitingJobsTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            writeStartElement(null, namespace, "includeWaitingJobs", xmlWriter);

            if (false) {

                throw new org.apache.axis2.databinding.ADBException("includeWaitingJobs cannot be null!!");

            } else {
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localIncludeWaitingJobs));
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localIncludeWaitingJobsTracker) {
            ...
            elementList.add(
                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localIncludeWaitingJobs));
        }
    ...
    public static class Factory {
         ...
         */
        public static GetActiveJobsParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetActiveJobsParam object =
                    new GetActiveJobsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getActiveJobsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetActiveJobsParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "includeWaitingJobs").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "includeWaitingJobs" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setIncludeWaitingJobs(
