/**
 * RemoveAssetPermissionsParam.java
 * <p>
...
/**
 * RemoveAssetPermissionsParam bean class
 */

public class RemoveAssetPermissionsParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":removeAssetPermissionsParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "removeAssetPermissionsParam",
    ...
    public static class Factory {
         ...
         */
        public static RemoveAssetPermissionsParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RemoveAssetPermissionsParam object =
                    new RemoveAssetPermissionsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"removeAssetPermissionsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RemoveAssetPermissionsParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
