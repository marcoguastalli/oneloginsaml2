/**
 * GetDistinctMetadataValuesParam.java
 * <p>
...
/**
 * GetDistinctMetadataValuesParam bean class
 */

public class GetDistinctMetadataValuesParam
    ...
    /**
     * field for MetadataKey
     */

    protected java.lang.String localMetadataKey;
    ...
    public java.lang.String getMetadataKey() {
        return this.localMetadataKey;
    }

    /**
     * Auto generated setter method
     *
     * @param param MetadataKey
     */
    public void setMetadataKey(java.lang.String param) {

        this.localMetadataKey = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getDistinctMetadataValuesParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getDistinctMetadataValuesParam",
        ...
        namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
        writeStartElement(null, namespace, "metadataKey", xmlWriter);

        if (this.localMetadataKey == null) {
            // write the nil attribute

            throw new org.apache.axis2.databinding.ADBException("metadataKey cannot be null!!");

        } else {

            xmlWriter.writeCharacters(this.localMetadataKey);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localMetadataKey != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localMetadataKey));
        } else {
            throw new org.apache.axis2.databinding.ADBException("metadataKey cannot be null!!");
        }
    ...
    public static class Factory {
         ...
         */
        public static GetDistinctMetadataValuesParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetDistinctMetadataValuesParam object =
                    new GetDistinctMetadataValuesParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getDistinctMetadataValuesParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetDistinctMetadataValuesParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper
                                    .getTypeObject(
                                            nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "metadataKey").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "metadataKey" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setMetadataKey(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
