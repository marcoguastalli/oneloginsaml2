...
/**
 * PauseJobParam bean class
 */

public class PauseJobParam
    ...
    public static class Factory {
         ...
         */
        public static PauseJobParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PauseJobParam object =
                    new PauseJobParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"pauseJobParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (PauseJobParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
