/**
 * CreateMetadataFieldReturn.java
 * <p>
...
/**
 *  CreateMetadataFieldReturn bean class
 */
...
public class CreateMetadataFieldReturn
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":createMetadataFieldReturn",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "createMetadataFieldReturn",
    ...
    public static class Factory {
         ...
         */
        public static CreateMetadataFieldReturn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CreateMetadataFieldReturn object =
                    new CreateMetadataFieldReturn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"createMetadataFieldReturn".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (CreateMetadataFieldReturn) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
