...
/**
 * RemoveProjectAssetsParam bean class
 */

public class RemoveProjectAssetsParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":removeProjectAssetsParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "removeProjectAssetsParam",
    ...
    public static class Factory {
         ...
         */
        public static RemoveProjectAssetsParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RemoveProjectAssetsParam object =
                    new RemoveProjectAssetsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"removeProjectAssetsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RemoveProjectAssetsParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
