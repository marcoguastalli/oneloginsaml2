/**
 * UpdateVignettePublishFormatReturn.java
 * <p>
...
/**
 *  UpdateVignettePublishFormatReturn bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class UpdateVignettePublishFormatReturn
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":updateVignettePublishFormatReturn",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "updateVignettePublishFormatReturn",
    ...
    public static class Factory {
         ...
         */
        public static UpdateVignettePublishFormatReturn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateVignettePublishFormatReturn object =
                    new UpdateVignettePublishFormatReturn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateVignettePublishFormatReturn".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (UpdateVignettePublishFormatReturn) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper
                                    .getTypeObject(
                                            nsUri, type, reader);
                        }
