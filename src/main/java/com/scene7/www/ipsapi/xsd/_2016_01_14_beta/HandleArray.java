    ...
    */
    ...
    public void addItems(java.lang.String param) {
        if (this.localItems == null) {
            this.localItems = new java.lang.String[] {};
        }
            ...
            if (this.localItems != null) {
                ...
                for (int i = 0; i < this.localItems.length; i++) {
                    ...
                    if (this.localItems[i] != null) {
                        ...
                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localItems[i]));
                ...
                for (int i = 0; i < this.localItems.length; i++) {
                    ...
                    if (this.localItems[i] != null) {
                        elementList.add(new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                                "items"));
                        elementList.add(
                                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localItems[i]));
                    } else {
    ...
    public static class Factory {
         ...
         */
        public static HandleArray parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            HandleArray object =
                    new HandleArray();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"HandleArray".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (HandleArray) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
