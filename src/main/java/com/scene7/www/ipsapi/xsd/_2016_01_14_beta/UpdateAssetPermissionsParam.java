/**
 * UpdateAssetPermissionsParam.java
 * <p>
...
/**
 *  UpdateAssetPermissionsParam bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class UpdateAssetPermissionsParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":updateAssetPermissionsParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "updateAssetPermissionsParam",
    ...
    public static class Factory {
         ...
         */
        public static UpdateAssetPermissionsParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpdateAssetPermissionsParam object =
                    new UpdateAssetPermissionsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"updateAssetPermissionsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (UpdateAssetPermissionsParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
