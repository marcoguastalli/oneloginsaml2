   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public boolean isUrlModifierSpecified() {
        return localUrlModifierTracker;
    }
    ...
    public void setUrlModifier(java.lang.String param) {
        localUrlModifierTracker = param != null;
    ...
    public boolean isUrlPostApplyModifierSpecified() {
        return localUrlPostApplyModifierTracker;
    }
    ...
    public java.lang.String getUrlPostApplyModifier() {
        return localUrlPostApplyModifier;
    }
    ...
    public void setUrlPostApplyModifier(java.lang.String param) {
        localUrlPostApplyModifierTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localUrlModifierTracker) {
            ...
            if (localUrlModifier == null) {
                ...
                xmlWriter.writeCharacters(localUrlModifier);

            }

            xmlWriter.writeEndElement();
        }
        if (localUrlPostApplyModifierTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            writeStartElement(null, namespace, "urlPostApplyModifier", xmlWriter);

            if (localUrlPostApplyModifier == null) {
                // write the nil attribute
                ...
                xmlWriter.writeCharacters(localUrlPostApplyModifier);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localUrlModifierTracker) {
            ...
            if (localUrlModifier != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUrlModifier));
            } else {
                throw new org.apache.axis2.databinding.ADBException("urlModifier cannot be null!!");
            }
        }
        if (localUrlPostApplyModifierTracker) {
            ...
            if (localUrlPostApplyModifier != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUrlPostApplyModifier));
            } else {
                throw new org.apache.axis2.databinding.ADBException("urlPostApplyModifier cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static WatermarkInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            WatermarkInfo object =
                    new WatermarkInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"WatermarkInfo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (WatermarkInfo) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "url")
