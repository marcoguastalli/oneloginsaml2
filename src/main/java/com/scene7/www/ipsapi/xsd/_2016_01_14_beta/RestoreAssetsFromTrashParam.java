/**
 * RestoreAssetsFromTrashParam.java
 * <p>
...
/**
 * RestoreAssetsFromTrashParam bean class
 */

public class RestoreAssetsFromTrashParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":restoreAssetsFromTrashParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "restoreAssetsFromTrashParam",
    ...
    public static class Factory {
         ...
         */
        public static RestoreAssetsFromTrashParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RestoreAssetsFromTrashParam object =
                    new RestoreAssetsFromTrashParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"restoreAssetsFromTrashParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RestoreAssetsFromTrashParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
