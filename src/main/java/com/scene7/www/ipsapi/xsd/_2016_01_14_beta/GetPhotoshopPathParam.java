...
/**
 * GetPhotoshopPathParam bean class
 */

public class GetPhotoshopPathParam
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getPhotoshopPathParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getPhotoshopPathParam",
        ...
        if (this.localPathName == null) {
            // write the nil attribute

            throw new org.apache.axis2.databinding.ADBException("pathName cannot be null!!");

        } else {

            xmlWriter.writeCharacters(this.localPathName);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localPathName != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localPathName));
        } else {
            throw new org.apache.axis2.databinding.ADBException("pathName cannot be null!!");
        }
    ...
    public static class Factory {
         ...
         */
        public static GetPhotoshopPathParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetPhotoshopPathParam object =
                    new GetPhotoshopPathParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getPhotoshopPathParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetPhotoshopPathParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "pathName")
                        .equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "pathName" + "  cannot be null");
                    }
