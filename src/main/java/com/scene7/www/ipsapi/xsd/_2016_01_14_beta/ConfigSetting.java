...
public class ConfigSetting
   ...
   *   for this attribute. It will be used to determine whether to include this field
    *   in the serialized XML
    */
    protected boolean localHandleTracker = false;
    ...
    public boolean isHandleSpecified() {
        return this.localHandleTracker;
    }
    ...
    public void setHandle(java.lang.String param) {
        this.localHandleTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (this.localHandleTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            writeStartElement(null, namespace, "handle", xmlWriter);

            if (this.localHandle == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("handle cannot be null!!");

            } else {

                xmlWriter.writeCharacters(this.localHandle);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localHandleTracker) {
            ...
            if (this.localHandle != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localHandle));
            } else {
                throw new org.apache.axis2.databinding.ADBException("handle cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ConfigSetting parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ConfigSetting".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ConfigSetting) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta", "handle")
                        .equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "handle" + "  cannot be null");
                    }
