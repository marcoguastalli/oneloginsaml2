...
/**
 * SaveImageFormatParam bean class
 */

public class SaveImageFormatParam
    ...
    /**
     * field for ImageFormatHandle
     */

    protected java.lang.String localImageFormatHandle;
    /*  This tracker boolean wil be used to detect whether the user called the set method
   *   for this attribute. It will be used to determine whether to include this field
    *   in the serialized XML
    */
    protected boolean localImageFormatHandleTracker = false;
    /**
     * field for Name
     */
    ...
    public boolean isImageFormatHandleSpecified() {
        return this.localImageFormatHandleTracker;
    }
    ...
    public java.lang.String getImageFormatHandle() {
        return this.localImageFormatHandle;
    }

    /**
     * Auto generated setter method
     *
     * @param param ImageFormatHandle
     */
    public void setImageFormatHandle(java.lang.String param) {
        this.localImageFormatHandleTracker = param != null;

        this.localImageFormatHandle = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":saveImageFormatParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "saveImageFormatParam",
        ...
        if (this.localImageFormatHandleTracker) {
            namespace = "http://www.scene7.com/IpsApi/xsd/2016-01-14-beta";
            writeStartElement(null, namespace, "imageFormatHandle", xmlWriter);

            if (this.localImageFormatHandle == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("imageFormatHandle cannot be null!!");

            } else {

                xmlWriter.writeCharacters(this.localImageFormatHandle);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localImageFormatHandleTracker) {
            ...
            if (this.localImageFormatHandle != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localImageFormatHandle));
            } else {
                throw new org.apache.axis2.databinding.ADBException("imageFormatHandle cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SaveImageFormatParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SaveImageFormatParam object =
                    new SaveImageFormatParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"saveImageFormatParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (SaveImageFormatParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.scene7.com/IpsApi/xsd/2016-01-14-beta",
                        "imageFormatHandle").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "imageFormatHandle" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setImageFormatHandle(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
