/**
 * GetPhotoshopPathNamesParam.java
 * <p>
...
/**
 * GetPhotoshopPathNamesParam bean class
 */

public class GetPhotoshopPathNamesParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getPhotoshopPathNamesParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getPhotoshopPathNamesParam",
    ...
    public static class Factory {
         ...
         */
        public static GetPhotoshopPathNamesParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetPhotoshopPathNamesParam object =
                    new GetPhotoshopPathNamesParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getPhotoshopPathNamesParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetPhotoshopPathNamesParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
