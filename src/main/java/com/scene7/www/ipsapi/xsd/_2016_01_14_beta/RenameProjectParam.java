...
/**
 * RenameProjectParam bean class
 */

public class RenameProjectParam
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":renameProjectParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "renameProjectParam",
        ...
        if (this.localProjectName == null) {
            ...
            xmlWriter.writeCharacters(this.localProjectName);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (this.localProjectName != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localProjectName));
        } else {
            throw new org.apache.axis2.databinding.ADBException("projectName cannot be null!!");
        }
    ...
    public static class Factory {
         ...
         */
        public static RenameProjectParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RenameProjectParam object =
                    new RenameProjectParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"renameProjectParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RenameProjectParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
