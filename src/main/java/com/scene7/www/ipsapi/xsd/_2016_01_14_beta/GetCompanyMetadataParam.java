...
/**
 *  GetCompanyMetadataParam bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetCompanyMetadataParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":getCompanyMetadataParam",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "getCompanyMetadataParam",
    ...
    public static class Factory {
         ...
         */
        public static GetCompanyMetadataParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetCompanyMetadataParam object =
                    new GetCompanyMetadataParam();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getCompanyMetadataParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GetCompanyMetadataParam) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
