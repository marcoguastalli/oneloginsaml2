...
/**
 * PostScriptInfo bean class
 */

public class PostScriptInfo
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":PostScriptInfo",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "PostScriptInfo",
    ...
    public static class Factory {
         ...
         */
        public static PostScriptInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PostScriptInfo object =
                    new PostScriptInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PostScriptInfo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (PostScriptInfo) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
