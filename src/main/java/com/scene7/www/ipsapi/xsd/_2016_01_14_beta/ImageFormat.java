...
public class ImageFormat
    ...
    public static class Factory {
         ...
         */
        public static ImageFormat parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ImageFormat object =
                    new ImageFormat();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ImageFormat".equals(type)) {
                            ...
                            return (ImageFormat) com.scene7.www.ipsapi.xsd._2016_01_14_beta.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
